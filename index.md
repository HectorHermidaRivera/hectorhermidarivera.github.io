...
">
  ...
  <!-- PAGE TITLE -->
<h1 class="main-name" style="padding-left:5 !important; padding-right:5px !important;">
  Héctor <strong>Hermida-Rivera</strong>
</h1>

  <!-- ICONS ROW: LEFT-ALIGNED -->
  <div class="icon-row" style="margin-bottom:2em; margin-left:0px;">
...
<div style="width:100%; margin-top:2em; padding-left:5px; padding-right:5px">
